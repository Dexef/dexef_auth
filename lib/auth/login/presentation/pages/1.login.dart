...
////////////////////////////////////////////////////////////////////////////////
  ...
  void initState() {
    ...
    loginCubit?.socialLogin == 'Google' ? loginCubit!.credGoogleWeb!.user!
        .email! : loginCubit?.socialLogin == 'apple'
          ...
          if (state is ValidateEmailSuccess) {
            if (state.validateEmailEntity?.data?.customerStatus == null) {
              loginCubit?.emailType =
                  loginCubit?.validateEmailEntity?.data?.type ??
                      CacheHelper.getData(key: Constants.emailType.toString());
              phoneOrEmail =
              loginCubit?.socialLogin == AppConstants.googleString
...
////////////////////////////////////////////////////////////////////////////////
  getListenerForApple(LoginCubit loginCubit, LoginState state) {
    if (state is SignUpAppleSuccess) {
      ...
      CacheHelper.saveData(
          key: Constants.isLoggedFromApple.toString(), value: true);
      goHome();
...
////////////////////////////////////////////////////////////////////////////////
  getListenerForNormalDesign(LoginCubit loginCubit, LoginState state) {
    if (state is LoginSuccess) {
      CacheHelper.saveData(
          key: Constants.isLoggedFromGoogle.toString(), value: false);
      CacheHelper.saveData(
          key: Constants.isLoggedFromApple.toString(), value: false);
      goHome();
